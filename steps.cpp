...
//    pushButton_tot_add->setEnabled(step == 3 || DISABLE_STEPS_INTERFACE_BLOCK);
    ...
    pushButton_nextStep_tot->setEnabled(step == 4 || DISABLE_STEPS_INTERFACE_BLOCK);
...
//    pushButton_clear_skleiki_1_editing->setEnabled(step == 5 || DISABLE_STEPS_INTERFACE_BLOCK);
    ...
    pushButton_nextStep_onesOnly->setEnabled(step == 6 || DISABLE_STEPS_INTERFACE_BLOCK);
...
//    pushButton_clear_skleiki_2_editing->setEnabled(step == 7 || DISABLE_STEPS_INTERFACE_BLOCK);
    ...
    pushButton_nextStep_skleyki_2->setEnabled(step == 8 || DISABLE_STEPS_INTERFACE_BLOCK);
...
//    pushButton_clearSkleyki_2->setEnabled(step == 9 || DISABLE_STEPS_INTERFACE_BLOCK);
    ...
    pushButton_nextStep_onesOnly_3->setEnabled(step == 10 || DISABLE_STEPS_INTERFACE_BLOCK);
    // этап 11 (проверка карты минимизации)
    stepName[10] = "проверка карты минимизации";
    pushButton_proverka_karti_minimizacii->setEnabled(step == 11 || DISABLE_STEPS_INTERFACE_BLOCK);
    if(step == 11)
    {
    ...
    pushButton_proverka_karta_minimizacii->setEnabled(step == 12 || DISABLE_STEPS_INTERFACE_BLOCK);
    pushButton_setRedColor->setEnabled(step == 12 || DISABLE_STEPS_INTERFACE_BLOCK);
    pushButton_setGreenColor->setEnabled(step == 12 || DISABLE_STEPS_INTERFACE_BLOCK);
    pushButton_setWhiteColor->setEnabled(step == 12 || DISABLE_STEPS_INTERFACE_BLOCK);
